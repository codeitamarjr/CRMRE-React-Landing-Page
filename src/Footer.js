                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        ...
                                        <p className="mt-1 text-xs text-gray-500">
                                            We partner with <a href="https://clarity.microsoft.com" target='_blank' rel='noreferrer' className="hover:underline text-indigo-600">Microsoft Clarity</a> to capture how you use and interact with our website through behavioral metrics, heatmaps, and session replay to improve and market our products/services. Website usage data is captured using first and third-party cookies and other tracking technologies to determine the popularity of products/services and online activity. Additionally, we use this information for site optimization, fraud/security purposes, and advertising. For more information about how Microsoft collects and uses your data, visit the <a href='https://privacy.microsoft.com/en-us/privacystatement' target='_blank' rel='noreferrer' className="hover:underline text-indigo-600">Microsoft Privacy Statement</a>.
                                        </p>
                                    </div>
