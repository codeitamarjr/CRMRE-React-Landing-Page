        ...
        <div className="h-screen w-full relative isolate px-6 pt-14 lg:px-8">
            ...
            <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
                ...
                <div className="text-center">
                    <p className="text-8xl md:text-8xl font-extrabold bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.indigo.400),theme(colors.indigo.100),theme(colors.sky.400),theme(colors.fuchsia.400),theme(colors.sky.400),theme(colors.indigo.100),theme(colors.indigo.400))] bg-[length:200%_auto] animate-gradient">
                        Real Enquiries
                    </p>
