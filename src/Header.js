        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="lg:flex lg:flex-1 lg:justify-end text-indigo-500 dark:text-indigo-400">
                    <a href="mailto:contact@realenquiries.com?subject=CRMRE: Contact&body=Tell me more about Real Enquiries!" className="text-sm font-semibold leading-6">Join the Waiting List</a>
                </div>
            </nav>
        </header>
    );
